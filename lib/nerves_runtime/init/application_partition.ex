defmodule Nerves.Runtime.Init.ApplicationPartition do
  @moduledoc """
  Handles application data partition initialization.

  Application data partition initialization currently consists of:
